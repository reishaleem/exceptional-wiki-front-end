...
export default ({ id }) => {
    ...
    useEffect(() => {
        TaskService.getUniverseTaskList(id).then((response) => {
                            ...
                            >
                                <Form.Row>
                                    <Col md={8}>
                                        ...
                                        {errors.newTaskName && (
                                            <small>
                                                Must not be empty or more than
                                                50 characters
                                            </small>
                                        )}
                                    </Col>
