      ...
      >
        ...
        <ListGroup variant="flush">
          <Accordion defaultActiveKey="0">
            ...
            <Accordion.Collapse eventKey="0" style={{ fontSize: "13px" }}>
              <ListGroup variant="flush">
                <ListGroup.Item
                  as={Link}
                  to={"#"}
            ...
            <ListGroup.Item as={Link} to={"#"} action>
              <FontAwesomeIcon
                ...
                size="lg"
              ></FontAwesomeIcon>
              Potentially add here pinned places (such as list of characters,
              spells, etc...)
            </ListGroup.Item>
            ...
            <Accordion.Collapse eventKey="1" style={{ fontSize: "13px" }}>
              <ListGroup variant="flush">
                <ListGroup.Item
                  as={Link}
                  to={"#"}
                ...
                >
                  <FontAwesomeIcon
                    ...
                    size="lg"
                  ></FontAwesomeIcon>
                  Wiki Templates (This is where you create your own. Not where
                  you start an article from one)
                </ListGroup.Item>
                <ListGroup.Item
                  as={Link}
                  to={"#"}
                ...
                >
                  <FontAwesomeIcon
                    ...
                    size="lg"
                  ></FontAwesomeIcon>
                  Notebook (Set this up almost like a mini OneNote...)
                </ListGroup.Item>
                <ListGroup.Item
                  as={Link}
                  to={"#"}
                ...
                >
                  <FontAwesomeIcon
                    ...
                    size="lg"
                  ></FontAwesomeIcon>
                  Sheets (this is like character sheets and stuff. But not the
                  actual article. We want to be able to make characters without
