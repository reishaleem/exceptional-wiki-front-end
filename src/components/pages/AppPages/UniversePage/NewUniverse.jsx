    ...
    const onSubmit = (data) => {
        ...
        UniverseService.createUniverse(
            ...
            (response) => {
                ...
                setSuccessful(true);
                history.push(
                    `/app/universes/${response.data.idOfCreatedDocument}/wikis`
                );
            },
            (error) => {
                const resMessage =
                    ...
                    <Row style={{ paddingBottom: "15px" }}>
                        <Col md={3}>
                            <p>
                                ...
                                universe, then underneath that, maybe a genre
                                thing. Not sure if needed there. Can instead do
                                created date.
                            </p>
                        </Col>
                        <Col md={9}>
