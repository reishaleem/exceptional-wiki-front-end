        ...
        <Container className="pt-5">
          ...
          <section className="mb-5">
            ...
            <Row>
              <Col md={3}>
                <p>
                  Our goal is to provide you the best experience on the market.
                  We are continously improving to ensure we meet that goal. All
                  user feedback is taken seriously, because your experience is
              ...
              <Col md={9}>
                <CardColumns>
                  ...
                  <Card>
                    ...
                    <Card.Body>
                      <Card.Text>
                        The Generator that will generate names for anything,
                        such as characters, weapons, locations, and many more.
                        The Generator will provide users the ability to generate
                        from a given Seed File, as well as understand the
                        etymology of the word, so that their names can still
