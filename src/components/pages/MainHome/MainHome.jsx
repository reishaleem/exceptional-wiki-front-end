              ...
              <CardDeck>
                <Card>
                  <Card.Body>
                    ...
                    <br></br>
                    <Card.Text>
                      With wiki-like pages, create and expand your one-of-a-kind
                      world. Build your characters, countries, magic, and more
                      from scratch, or use the provided questionnaires to get
                      your brain working!
                    </Card.Text>
                  </Card.Body>
                </Card>
                <Card>
                  <Card.Body>
                    ...
                    <Card.Text>
                      ...
                      characters, locations, and more. You can corrupt generated
                      words and provide language root options, among many more
                      features!
                    </Card.Text>
                  </Card.Body>
                </Card>
                <Card>
                  <Card.Body>
                    ...
                    <br></br>
                    <Card.Text>
                      Outline your story, or start from the first chapter. Take
                      advantage of the script and storyboard functions for
                      comics or screenplays. Write high quality stories with our
      ...
      <Row className="test">
        ...
        <Col md={6}>
          ...
          <p style={{ fontSize: "18px", marginBottom: "1.5rem" }}>
            Different authors have different styles when it comes to outlining.
            Some will outline every last detail, while others will simply put
            pen to paper and see what happens next. Whatever the case may be, we
            aim to help you keep your stories in order and safe, so that you can
            let your ideas flourish in the best way possible.
          </p>
          <p style={{ fontSize: "18px", marginBottom: "1.5rem" }}>
