                ...
                <Row className="test">
                    ...
                    <Col md={6}>
                        ...
                        <p style={{ fontSize: "18px", marginBottom: "1.5rem" }}>
                            Different authors have different styles when it
                            comes to outlining. Some will outline every last
                            detail, while others will simply put pen to paper
                            and see what happens next. Whatever the case may be,
                            we aim to help you keep your stories in order and
                            safe, so that you can let your ideas flourish in the
                            best way possible.
                        </p>
                        <p style={{ fontSize: "18px", marginBottom: "1.5rem" }}>
                            The Exceptional Outliner is a tool for even the
                            purest gardeners. With our simple UI, variety of
                            features, and great support, our platform is truly
                            one-of-a-kind. And that is our goal. To be different
                            from the others. To truly be - Exceptional.
                        </p>
                        <p style={{ fontSize: "18px", marginBottom: "1.5rem" }}>
